...
estimation(datafile=us_data,mode_compute=0,first_obs=5,presample=4,mode_file=NK_RES_Course_est_PI_mode,
              prefilter=0,mh_replic=1000,mh_nblocks=2,mh_jscale=0.40,mh_drop=0.2);
...
stoch_simul(irf=20,ar=10,conditional_variance_decomposition=[1 4 10 100]) dy pinfobs robs;
