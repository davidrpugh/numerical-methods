...
std(robs(5:end))
fprintf('STD Nominal rental rate ')
std(rkn_obs(5:end))
...
fprintf('Cross-Correlation Nominal Rental Rate-Output ')
corrcoef(rkn_obs(5:end),dy(5:end))
...
fprintf('Autocorrelation Nomianal Rental Rate ')
acfcomp(rkn_obs(5:end))