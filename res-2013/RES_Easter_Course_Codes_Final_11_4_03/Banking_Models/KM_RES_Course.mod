...
//
//
//Banking sector calibrated to spread, entrepreneurs consumption
//
//
//Note ss of BGG model with is not the same as the flexi-price
//

//Add intertemporal welfare OMEGA in Bellman equation form
// 
///////////////////////////////////////////////////////////////////////////////////////////////// 
...
//
//////////////////////////////
//Set sigma_entre and m
//
//near risk-neutral case
//
//sigma_entre=0.001;
//sigma_entre=0.0001;//unstable
//////////////////////////////////
// Priors for m, sigma_entre if estimated
/////////////////////////////////

m=0.25;
sigma_entre=0.5;//KM 
//sigma_entre=0.001;//KM1 
//sigma_entre=0.999;//KM2
//sigma_entre=2.0;//KM3
//
//////////////////////////////////
//
zzetaL=500;
spreadcalib=0.01/4;
//spreadcalib=0.00;//zero spread case
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%
%ccalibration of varrho and betta
%%%%%%%%%%%%%%%%%%%%%%%%%
...
TE=STEADY_STATE(TE);
%
%plus binding constraint 
%
QK=Q*K(-1);
RL*L=m*(1-delta)*QK(+1)*PIE(+1);
%
%plus entrepreneur's BC 
%
...
//irfs 
//
stoch_simul(order=1,irf=40) QQ PIEPIE RnRn YY CC CECE II hh WPWP RR OUTGAPOUTGAP 
