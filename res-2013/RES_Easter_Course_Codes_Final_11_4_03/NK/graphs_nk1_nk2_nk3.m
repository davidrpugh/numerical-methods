...
load NK_free_parameters_1_RES_Course_results
...
WP_epscapqual    = oo_.irfs.WPWP_epscapqual;
R_epscapqual     = oo_.irfs.RR_epscapqual;
...
irfs_NK1_epscapqual =[Y_epscapqual;  C_epscapqual;  I_epscapqual; h_epscapqual;  WP_epscapqual;  R_epscapqual; Rn_epscapqual; Q_epscapqual; PIE_epscapqual];
...
load NK_free_parameters_2_RES_Course_results
%Rename the IRFs for each variable of interest in the non linear model
Y_epsA     = oo_.irfs.YY_epsA;
C_epsA     = oo_.irfs.CC_epsA;
I_epsA     = oo_.irfs.II_epsA;
...
irfs_NK2_epscapqual =[Y_epscapqual;  C_epscapqual;  I_epscapqual; h_epscapqual;  WP_epscapqual;  R_epscapqual; Rn_epscapqual; Q_epscapqual; PIE_epscapqual];


load NK_free_parameters_3_RES_Course_results
%Rename the IRFs for each variable of interest in the non linear model
Y_epsA     = oo_.irfs.YY_epsA;
C_epsA     = oo_.irfs.CC_epsA;
I_epsA     = oo_.irfs.II_epsA;
...
%Create a vector of IRFs per each shock
irfs_NK3_epsA =[Y_epsA;  C_epsA;  I_epsA; h_epsA;  WP_epsA;  R_epsA; Rn_epsA; Q_epsA; PIE_epsA];
irfs_NK3_epsG =[Y_epsG;  C_epsG;  I_epsG; h_epsG;  WP_epsG;  R_epsG; Rn_epsG; Q_epsG; PIE_epsG];
irfs_NK3_epsMS =[Y_epsMS;  C_epsMS;  I_epsMS; h_epsMS;  WP_epsMS;  R_epsMS; Rn_epsMS; Q_epsMS; PIE_epsMS];
irfs_NK3_epsMPS =[Y_epsMPS;  C_epsMPS;  I_epsMPS; h_epsMPS;  WP_epsMPS;  R_epsMPS; Rn_epsMPS; Q_epsMPS; PIE_epsMPS];
irfs_NK3_epsAtrend =[Y_epsAtrend;  C_epsAtrend;  I_epsAtrend; h_epsAtrend;  WP_epsAtrend;  R_epsAtrend; Rn_epsAtrend; Q_epsAtrend; PIE_epsAtrend];
irfs_NK3_epscapqual =[Y_epscapqual;  C_epscapqual;  I_epscapqual; h_epscapqual;  WP_epscapqual;  R_epscapqual; Rn_epscapqual; Q_epscapqual; PIE_epscapqual];
...
for j = 1:9;
    subplot(3,3,j), plot(irfs_NK1_epsA (j,:),'-k', 'LineWidth',2, 'MarkerSize', 5,'MarkerEdgeColor','k', 'MarkerFaceColor','k'); hold on;
                    ...
                    plot(irfs_NK3_epsA(j,:),':b', 'LineWidth',2, 'MarkerSize', 5,'MarkerEdgeColor','k', 'MarkerFaceColor','r'); hold on;
...
legend('NK (zero inflation)', 'NK (low inflation)', 'NK (high inflation)', 'Orientation', 'horizontal')
...
for j = 1:9;
    subplot(3,3,j), plot(irfs_NK1_epsG (j,:),'-k', 'LineWidth',2, 'MarkerSize', 5,'MarkerEdgeColor','k', 'MarkerFaceColor','k'); hold on;
                    ...
                    plot(irfs_NK3_epsG(j,:),':b', 'LineWidth',2, 'MarkerSize', 5,'MarkerEdgeColor','k', 'MarkerFaceColor','r'); hold on;
...
legend('NK (zero inflation)', 'NK (low inflation)', 'NK (high inflation)', 'Location', 'Best','Orientation', 'horizontal')
...
for j = 1:9;
    subplot(3,3,j), plot(irfs_NK1_epsMS (j,:),'-k', 'LineWidth',2, 'MarkerSize', 5,'MarkerEdgeColor','k', 'MarkerFaceColor','k'); hold on;
                    ...
                    plot(irfs_NK3_epsMS(j,:),':b', 'LineWidth',2, 'MarkerSize', 5,'MarkerEdgeColor','k', 'MarkerFaceColor','r'); hold on;
...
for j = 1:9;
    subplot(3,3,j), plot(irfs_NK1_epsMPS (j,:),'-k', 'LineWidth',2, 'MarkerSize', 5,'MarkerEdgeColor','k', 'MarkerFaceColor','k'); hold on;
                    ...
                    plot(irfs_NK3_epsMPS(j,:),':b', 'LineWidth',2, 'MarkerSize', 5,'MarkerEdgeColor','k', 'MarkerFaceColor','r'); hold on;
...
for j = 1:9;
    subplot(3,3,j), plot(irfs_NK1_epsAtrend (j,:),'-k', 'LineWidth',2, 'MarkerSize', 5,'MarkerEdgeColor','k', 'MarkerFaceColor','k'); hold on;
                    ...
                    plot(irfs_NK3_epsAtrend(j,:),':b', 'LineWidth',2, 'MarkerSize', 5,'MarkerEdgeColor','k', 'MarkerFaceColor','r'); hold on;
...
for j = 1:9;
    subplot(3,3,j), plot(irfs_NK1_epscapqual (j,:),'-k', 'LineWidth',2, 'MarkerSize', 5,'MarkerEdgeColor','k', 'MarkerFaceColor','k'); hold on;
                    ...
                    plot(irfs_NK3_epscapqual(j,:),':b', 'LineWidth',2, 'MarkerSize', 5,'MarkerEdgeColor','k', 'MarkerFaceColor','r'); hold on;
