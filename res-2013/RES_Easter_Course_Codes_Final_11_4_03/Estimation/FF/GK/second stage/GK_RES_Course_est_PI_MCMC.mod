...
GF Stochg capqual RkRk phiphi betta;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
estimation(datafile=us_data,mode_compute=0,first_obs=5,presample=4,mode_file=GK_RES_Course_est_PI_mode,
              prefilter=0,mh_replic=1000,mh_nblocks=2,mh_jscale=0.15,mh_drop=0.2);
