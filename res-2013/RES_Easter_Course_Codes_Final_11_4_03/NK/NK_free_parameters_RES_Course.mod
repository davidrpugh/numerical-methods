...
alpha_r $\alpha_r$
theta_pi $\theta_{\pi}$ rhocapqual ppsi  betta varrho;
...
//
PIEss=1.0063;//calibrated case
PIEss=1.0125;//high inflation
//PIEss=1.025;//very high inflation
