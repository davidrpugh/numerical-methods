...
//RBC model with varrho calibrated to hit hours and delta to hit investment share 
...
RR   YY CC hh WPWP II KK varrho delta; 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
parameters gy alp c zzeta betta sigma_c rhoA rhoG Ass hobs iobs;
...
model;
%------------------------------
%Calibration of varrho and delta
%------------------------------
%
