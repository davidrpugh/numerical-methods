...
load RBClinear_RES_Course_results

%Rename the IRFs for each variable of interest in the linear model
Y_epsA     = oo_.irfs.Y_epsA;
C_epsA     = oo_.irfs.C_epsA;
I_epsA     = oo_.irfs.I_epsA;
h_epsA     = oo_.irfs.h_epsA;
WP_epsA    = oo_.irfs.WP_epsA;
R_epsA     = oo_.irfs.R_epsA;


Y_epsG     = oo_.irfs.Y_epsG;
C_epsG     = oo_.irfs.C_epsG;
I_epsG     = oo_.irfs.I_epsG;
h_epsG     = oo_.irfs.h_epsG;
WP_epsG    = oo_.irfs.WP_epsG;
R_epsG     = oo_.irfs.R_epsG;

%Create a vector of IRFs per each shock
irfs_RBC_l_epsA =[Y_epsA;  C_epsA;  I_epsA; h_epsA;  WP_epsA;  R_epsA];
irfs_RBC_l_epsG =[Y_epsG;  C_epsG;  I_epsG; h_epsG;  WP_epsG;  R_epsG];
...
for j = 1:6;
    subplot(3,2,j), plot(irfs_RBC_nl_epsA (j,:),'-k', 'LineWidth',2, 'MarkerSize', 5,'MarkerEdgeColor','k', 'MarkerFaceColor','k'); hold on;
                    plot(irfs_RBC_l_epsA(j,:),'--r', 'LineWidth',2, 'MarkerSize', 5,'MarkerEdgeColor','k', 'MarkerFaceColor','r'); hold on;
                    xlabel('Quarters');
                    ylabel('% dev from SS');
                    grid on
...
legend('Non-linear', 'Linear', 'Location', 'Best', 'Orientation', 'horizontal')
...
for j = 1:6;
    subplot(3,2,j), plot(irfs_RBC_nl_epsG (j,:),'-k', 'LineWidth',2, 'MarkerSize', 5,'MarkerEdgeColor','k', 'MarkerFaceColor','k'); hold on;
                    plot(irfs_RBC_l_epsG(j,:),'--r', 'LineWidth',2, 'MarkerSize', 5,'MarkerEdgeColor','k', 'MarkerFaceColor','r'); hold on;
                    xlabel('Quarters');
                    ylabel('% dev from SS');
                    grid on
                    title(names(j,:),'FontSize',10)
