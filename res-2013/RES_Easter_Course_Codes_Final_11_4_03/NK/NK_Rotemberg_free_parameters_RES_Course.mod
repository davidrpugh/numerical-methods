...
//varrho and betta  set as free (exogenous) parameters
//
//
//
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
parameters gy  alp c zzeta betta varrho delta sigma_c rhoA rhoG rhoMS rhoMPS
Ass  phiX xi theta_y hab hss g gamp PIEss
alpha_r $\alpha_r$
...
%
%
%positive inflation calibration
%
%varrho=0.891429;
%betta= 0.998313;
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
