...
legend('KM(\sigma_E=0)', 'KM(\sigma_E=1)', 'KM(\sigma_E=2)', 'Best', 'Orientation', 'horizontal')
...
legend('KM(\sigma_E=0)', 'KM2 ','KM(\sigma_E=2)', 'Location', 'Best', 'Orientation', 'horizontal')
...
legend('KM(\sigma_E=0)', 'KM(\sigma_E=1)', 'KM(\sigma_E=2)', 'Location', 'Best', 'Orientation', 'horizontal')
